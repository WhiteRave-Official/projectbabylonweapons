...
public final class GoldenSmallShieldPassive {
    private static final WeaponPassiveTooltipData TOOLTIP = new WeaponPassiveTooltipData(
            Component.translatable("tooltip.project_babylon_weapons.passive.small_shield_golden.name"),
            ...
            List.of(Component.translatable("tooltip.project_babylon_weapons.passive.small_shield_golden.line1").withStyle(ChatFormatting.GRAY)),
            TooltipFrameStyle.material("golden")
    );

    private GoldenSmallShieldPassive() {
    }
