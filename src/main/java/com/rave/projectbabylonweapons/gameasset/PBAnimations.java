...
public class PBAnimations {
    ...
    public static AnimationManager.AnimationAccessor<AttackAnimation> EVERGATE_EXTRA_AUTO_4;
    ...
    public static AnimationManager.AnimationAccessor<AttackAnimation> SUMMON;
...
//ARCLIGHT
        ...
        })).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(1.5F)).addProperty(AnimationProperty.AttackPhaseProperty.PARTICLE, EpicFightParticles.EVISCERATE).addProperty(PBAnimationProperties.IGNORE_ENTITY_COLLISION, true).addProperty(AnimationProperty.ActionAnimationProperty.STOP_MOVEMENT, false).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.0F));

        ARCLIGHT_DASH = builder.nextAccessor("biped/combat/arclight_dash", (accessor) ->  new AttackAnimation(0.1F,  0.28F,  0.75F,  1.2F, 1.6F, (Collider)null, ((HumanoidArmature)Armatures.BIPED.get()).toolR, accessor, Armatures.BIPED).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(1.0F)).newTimePair(0.0F, 1.3F).addStateRemoveOld(EntityState.CAN_BASIC_ATTACK, false).addProperty(PBAnimationProperties.IGNORE_ENTITY_COLLISION, true).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.8F));
...
//EVERGATE
        ...
        })).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(0.5F)).newTimePair(0.0F, 1.8F).addStateRemoveOld(EntityState.CAN_BASIC_ATTACK, false).addProperty(AnimationProperty.ActionAnimationProperty.STOP_MOVEMENT, true).addProperty(PBAnimationProperties.IGNORE_ENTITY_COLLISION, true).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.8F)
        ...
        EVERGATE_AIRSLASH = builder.nextAccessor("biped/combat/evergate_airslash", (accessor) -> (AttackAnimation)(new AttackAnimation(0.1F, accessor, Armatures.BIPED, new AttackAnimation.Phase[]{
                ...
                })).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(1.5F)).addProperty(AnimationProperty.AttackPhaseProperty.PARTICLE, EpicFightParticles.EVISCERATE).addProperty(PBAnimationProperties.IGNORE_ENTITY_COLLISION, true).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.8F)
        ...
        EVERGATE_DASH = builder.nextAccessor("biped/combat/evergate_dash", (accessor) -> (AttackAnimation) (new AttackAnimation(0.25F, accessor, Armatures.BIPED, new AttackAnimation.Phase[]{
                new AttackAnimation.Phase(0.0F, 0.15F, 0.8F, 1.2F, 1.3F, 1.3F, InteractionHand.MAIN_HAND, ((HumanoidArmature) Armatures.BIPED.get()).toolR, PBColliderPresets.EVERGATE),
                new AttackAnimation.Phase(1.3F, 1.4F, 1.5F, 2.0F, 2.4F, 2.4F, InteractionHand.MAIN_HAND, ((HumanoidArmature) Armatures.BIPED.get()).toolR, PBColliderPresets.EVERGATE),
                new AttackAnimation.Phase(2.4F, 3.0F, 3.4F, 3.7F, 4.5F, 4.5F, InteractionHand.MAIN_HAND, ((HumanoidArmature) Armatures.BIPED.get()).toolR, PBColliderPresets.EVERGATE)
        })).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(0.5F)).newTimePair(0.0F, 3.8F).addStateRemoveOld(EntityState.CAN_BASIC_ATTACK, false).addProperty(PBAnimationProperties.IGNORE_ENTITY_COLLISION, true).addProperty(AnimationProperty.ActionAnimationProperty.STOP_MOVEMENT, true).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.7F));
        ...
        EVERGATE_EXTRA_DASH = builder.nextAccessor("biped/combat/evergate_extra_dash", (accessor) -> (AttackAnimation)(new AttackAnimation(0.1F, accessor, Armatures.BIPED, new AttackAnimation.Phase[]{
                        ...
                        .addEvents(AnimationEvent.InTimeEvent.create(0.2F, (entityPatch, animation, params) -> {LivingEntity entity = entityPatch.getOriginal(); entity.level().addParticle(EpicFightParticles.WHITE_AFTERIMAGE.get(), entity.getX(), entity.getY(), entity.getZ(), Double.longBitsToDouble(entity.getId()), 0.0D, 0.0D);}, AnimationEvent.Side.CLIENT))
                        .addEvents(AnimationEvent.InTimeEvent.create(0.4F, (entityPatch, animation, params) -> {LivingEntity entity = entityPatch.getOriginal(); entity.level().addParticle(EpicFightParticles.WHITE_AFTERIMAGE.get(), entity.getX(), entity.getY(), entity.getZ(), Double.longBitsToDouble(entity.getId()), 0.0D, 0.0D);}, AnimationEvent.Side.CLIENT))
                        .addEvents(AnimationEvent.InTimeEvent.create(0.6F, (entityPatch, animation, params) -> {LivingEntity entity = entityPatch.getOriginal(); entity.level().addParticle(EpicFightParticles.WHITE_AFTERIMAGE.get(), entity.getX(), entity.getY(), entity.getZ(), Double.longBitsToDouble(entity.getId()), 0.0D, 0.0D);}, AnimationEvent.Side.CLIENT))
                        .addEvents(AnimationEvent.InTimeEvent.create(0.8F, (entityPatch, animation, params) -> {LivingEntity entity = entityPatch.getOriginal(); entity.level().addParticle(EpicFightParticles.WHITE_AFTERIMAGE.get(), entity.getX(), entity.getY(), entity.getZ(), Double.longBitsToDouble(entity.getId()), 0.0D, 0.0D);}, AnimationEvent.Side.CLIENT))
                        ...
                        .addEvents(AnimationEvent.InTimeEvent.create(1.2F, (entityPatch, animation, params) -> {LivingEntity entity = entityPatch.getOriginal(); entity.level().addParticle(EpicFightParticles.WHITE_AFTERIMAGE.get(), entity.getX(), entity.getY(), entity.getZ(), Double.longBitsToDouble(entity.getId()), 0.0D, 0.0D);}, AnimationEvent.Side.CLIENT))
                        .addEvents(AnimationEvent.InTimeEvent.create(1.4F, (entityPatch, animation, params) -> {LivingEntity entity = entityPatch.getOriginal(); entity.level().addParticle(EpicFightParticles.WHITE_AFTERIMAGE.get(), entity.getX(), entity.getY(), entity.getZ(), Double.longBitsToDouble(entity.getId()), 0.0D, 0.0D);}, AnimationEvent.Side.CLIENT))
                        .addEvents(AnimationEvent.InTimeEvent.create(1.6F, (entityPatch, animation, params) -> {LivingEntity entity = entityPatch.getOriginal(); entity.level().addParticle(EpicFightParticles.WHITE_AFTERIMAGE.get(), entity.getX(), entity.getY(), entity.getZ(), Double.longBitsToDouble(entity.getId()), 0.0D, 0.0D);}, AnimationEvent.Side.CLIENT))
                        .addEvents(AnimationEvent.InTimeEvent.create(1.8F, (entityPatch, animation, params) -> {LivingEntity entity = entityPatch.getOriginal(); entity.level().addParticle(EpicFightParticles.WHITE_AFTERIMAGE.get(), entity.getX(), entity.getY(), entity.getZ(), Double.longBitsToDouble(entity.getId()), 0.0D, 0.0D);}, AnimationEvent.Side.CLIENT))
                        ...
                        .addEvents(AnimationEvent.InTimeEvent.create(2.6F, (entityPatch, animation, params) -> {LivingEntity entity = entityPatch.getOriginal(); entity.level().addParticle(EpicFightParticles.WHITE_AFTERIMAGE.get(), entity.getX(), entity.getY(), entity.getZ(), Double.longBitsToDouble(entity.getId()), 0.0D, 0.0D);}, AnimationEvent.Side.CLIENT))
        );
        ...
        EVERGATE_EXTRA_AUTO_4= builder.nextAccessor("biped/combat/evergate_extra_auto_4", (accessor) ->  new AttackAnimation(0.20F,  1.25F,  2.0F,  2.20F, 2.6F, ColliderPreset.FIST, ((HumanoidArmature)Armatures.BIPED.get()).toolL, accessor, Armatures.BIPED).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(1.0F)).newTimePair(0.0F, 2.25F).addStateRemoveOld(EntityState.CAN_BASIC_ATTACK, false).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.1F));
...
//SKILLS
        ...
        SUMMON = builder.nextAccessor("biped/skill/summon", (accessor) ->  new AttackAnimation(0.20F,  1.25F,  2.0F,  2.20F, 2.6F, ColliderPreset.FIST, ((HumanoidArmature)Armatures.BIPED.get()).toolL, accessor, Armatures.BIPED).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(1.0F)).newTimePair(0.0F, 2.25F).addStateRemoveOld(EntityState.CAN_BASIC_ATTACK, false).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.1F));
