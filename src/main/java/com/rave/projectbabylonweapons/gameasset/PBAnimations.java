...
//ARCLIGHT
        ...
        ARCLIGHT_AUTO_1 = builder.nextAccessor("biped/combat/arclight_auto_1", (accessor) ->  new AttackAnimation(0.45F,  0.45F,  0.4F,  0.8F, 1.0F, (Collider)null, ((HumanoidArmature)Armatures.BIPED.get()).toolR, accessor, Armatures.BIPED).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(1.0F)).newTimePair(0.0F, 1.0F).addStateRemoveOld(EntityState.CAN_BASIC_ATTACK, false).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.6F));
        ARCLIGHT_AUTO_2 = builder.nextAccessor("biped/combat/arclight_auto_2", (accessor) ->  new AttackAnimation(0.20F,  0.25F,  0.1F,  0.6F, 1.0F, (Collider)null, ((HumanoidArmature)Armatures.BIPED.get()).toolR, accessor, Armatures.BIPED).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(1.0F)).newTimePair(0.0F, 1.0F).addStateRemoveOld(EntityState.CAN_BASIC_ATTACK, false).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.6F));
        ARCLIGHT_AUTO_3 = builder.nextAccessor("biped/combat/arclight_auto_3", (accessor) ->  new AttackAnimation(0.35F,  0.25F,  0.2F,  1.2F, 1.3F, (Collider)null, ((HumanoidArmature)Armatures.BIPED.get()).toolR, accessor, Armatures.BIPED).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(1.0F)).newTimePair(0.0F, 1.3F).addStateRemoveOld(EntityState.CAN_BASIC_ATTACK, false).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.7F));
        ARCLIGHT_AUTO_4 = builder.nextAccessor("biped/combat/arclight_auto_4", (accessor) -> (AttackAnimation)(new AttackAnimation(0.25F, accessor, Armatures.BIPED, new AttackAnimation.Phase[]{
                new AttackAnimation.Phase(0.0F, 0.30F, 1.1F, 1.20F, 1.20F, InteractionHand.MAIN_HAND, ((HumanoidArmature)Armatures.BIPED.get()).toolR, (Collider)null),
                new AttackAnimation.Phase(1.20F, 1.80F, 2.4F, 3.2F, 3.2F, InteractionHand.MAIN_HAND, ((HumanoidArmature)Armatures.BIPED.get()).toolR, (Collider)null)
        ...
        EVERGATE_AIRSLASH = builder.nextAccessor("biped/combat/evergate_airslash", (accessor) -> (AttackAnimation)(new AttackAnimation(0.1F, accessor, Armatures.BIPED, new AttackAnimation.Phase[]{
                        ...
                        new AttackAnimation.Phase(1.4F, 2.90F, 3.5F, 3.6F, 3.6F, InteractionHand.MAIN_HAND, ((HumanoidArmature)Armatures.BIPED.get()).toolR, PBColliderPresets.EVERGATE)
                })).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(1.5F)).addProperty(AnimationProperty.AttackPhaseProperty.PARTICLE, EpicFightParticles.EVISCERATE).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.9F)
                        ...
                        .addEvents(new AnimationEvent[]{AnimationEvent.InTimeEvent.create(2.9f, PBReusableEvents.SMALL_GROUNDSLAM, AnimationEvent.Side.CLIENT).params(new Vec3f(0.0f, -0.24f, -2.0f))})
        );
        ...
        EVERGATE_DASH = builder.nextAccessor("biped/combat/evergate_dash", (accessor) -> (AttackAnimation) (new AttackAnimation(0.25F, accessor, Armatures.BIPED, new AttackAnimation.Phase[]{
                ...
                new AttackAnimation.Phase(1.7F, 1.7F, 1.75F, 2.4F, 2.7F, 2.7F, InteractionHand.MAIN_HAND, ((HumanoidArmature) Armatures.BIPED.get()).toolR, PBColliderPresets.EVERGATE)
        })).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(1.0F)).newTimePair(0.0F, 0.75F).addStateRemoveOld(EntityState.CAN_BASIC_ATTACK, false).addProperty(AnimationProperty.ActionAnimationProperty.STOP_MOVEMENT, true).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.8F));
        ...
        EVERGATE_EXTRA_AIRSLASH = builder.nextAccessor("biped/combat/evergate_extra_airslash", (accessor) -> (AttackAnimation)(new AttackAnimation(0.1F, accessor, Armatures.BIPED, new AttackAnimation.Phase[]{
                        new AttackAnimation.Phase(0.0F, 0.25F, 0.70F, 1.40F, 1.40F, InteractionHand.MAIN_HAND, ((HumanoidArmature)Armatures.BIPED.get()).toolR, PBColliderPresets.EVERGATE),
                        new AttackAnimation.Phase(1.4F, 1.50F, 2.0F, 2.1F, 2.1F, InteractionHand.MAIN_HAND, ((HumanoidArmature)Armatures.BIPED.get()).toolR, PBColliderPresets.EVERGATE)
                })).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(1.5F)).addProperty(AnimationProperty.AttackPhaseProperty.PARTICLE, EpicFightParticles.EVISCERATE).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.0F)
                        .addEvents(AnimationEvent.InTimeEvent.create(0.30F, (entityPatch, animation, params) -> {LivingEntity entity = entityPatch.getOriginal(); entity.level().addParticle(EpicFightParticles.WHITE_AFTERIMAGE.get(), entity.getX(), entity.getY(), entity.getZ(), Double.longBitsToDouble(entity.getId()), 0.0D, 0.0D);}, AnimationEvent.Side.CLIENT))
                        .addEvents(AnimationEvent.InTimeEvent.create(1.40F, (entityPatch, animation, params) -> {LivingEntity entity = entityPatch.getOriginal(); entity.level().addParticle(EpicFightParticles.WHITE_AFTERIMAGE.get(), entity.getX(), entity.getY(), entity.getZ(), Double.longBitsToDouble(entity.getId()), 0.0D, 0.0D);}, AnimationEvent.Side.CLIENT))
        ...
        EVERGATE_EXTRA_AUTO_1 = builder.nextAccessor("biped/combat/evergate_extra_auto_1", (accessor) ->  new AttackAnimation(0.25F,  0.25F,  0.3F,  2.4F, 2.7F, PBColliderPresets.EVERGATE, ((HumanoidArmature)Armatures.BIPED.get()).toolR, accessor, Armatures.BIPED).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(1.0F)).newTimePair(0.0F, 0.75F).addStateRemoveOld(EntityState.CAN_BASIC_ATTACK, false).addProperty(AnimationProperty.ActionAnimationProperty.STOP_MOVEMENT, true).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.8F));
