...
public class GoldenShortswordMagicDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof GoldenShortswordItem)) {
            return;
        }
        ...
        float bonusMagicDamage = event.getAmount() * GoldenShortswordItem.BONUS_MAGIC_DAMAGE_PERCENT;
