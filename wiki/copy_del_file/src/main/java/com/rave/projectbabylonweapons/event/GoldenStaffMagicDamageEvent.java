...
public class GoldenStaffMagicDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof GoldenStaffItem)) {
            return;
        }
        ...
        float bonusMagicDamage = event.getAmount() * GoldenStaffItem.BONUS_MAGIC_DAMAGE_PERCENT;
