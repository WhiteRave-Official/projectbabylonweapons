...
public class GoldenBattleScytheMagicDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof GoldenBattleScytheItem)) {
            return;
        }
        ...
        float bonusMagicDamage = event.getAmount() * GoldenBattleScytheItem.BONUS_MAGIC_DAMAGE_PERCENT;
