...
public class EtherealSickleHolyDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof EtherealSickleItem)) {
            return;
        }
        ...
        event.setAmount(originalDamage * EtherealSickleItem.PHYSICAL_DAMAGE_PERCENT);


        float holyDamage = originalDamage * EtherealSickleItem.HOLY_DAMAGE_PERCENT;
