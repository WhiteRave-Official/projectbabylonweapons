...
public class EtherealStaffHolyDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof EtherealStaffItem)) {
            return;
        }
        ...
        event.setAmount(originalDamage * EtherealStaffItem.PHYSICAL_DAMAGE_PERCENT);


        float holyDamage = originalDamage * EtherealStaffItem.HOLY_DAMAGE_PERCENT;
