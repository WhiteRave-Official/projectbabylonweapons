...
public class EtherealBattleHammerHolyDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof EtherealBattleHammerItem)) {
            return;
        }
        ...
        event.setAmount(originalDamage * EtherealBattleHammerItem.PHYSICAL_DAMAGE_PERCENT);


        float holyDamage = originalDamage * EtherealBattleHammerItem.HOLY_DAMAGE_PERCENT;
