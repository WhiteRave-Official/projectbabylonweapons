...
public class GoldenSickleMagicDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof GoldenSickleItem)) {
            return;
        }
        ...
        float bonusMagicDamage = event.getAmount() * GoldenSickleItem.BONUS_MAGIC_DAMAGE_PERCENT;
