...
public class GoldenBattleAxeMagicDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof GoldenBattleAxeItem)) {
            return;
        }
        ...
        float bonusMagicDamage = event.getAmount() * GoldenBattleAxeItem.BONUS_MAGIC_DAMAGE_PERCENT;
