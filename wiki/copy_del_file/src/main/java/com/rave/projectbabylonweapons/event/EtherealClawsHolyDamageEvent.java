...
public class EtherealClawsHolyDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof EtherealClawsItem)) {
            return;
        }
        ...
        event.setAmount(originalDamage * EtherealClawsItem.PHYSICAL_DAMAGE_PERCENT);


        float holyDamage = originalDamage * EtherealClawsItem.HOLY_DAMAGE_PERCENT;
