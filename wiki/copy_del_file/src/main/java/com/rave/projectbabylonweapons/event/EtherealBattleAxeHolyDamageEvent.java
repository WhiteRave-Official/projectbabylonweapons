...
public class EtherealBattleAxeHolyDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof EtherealBattleAxeItem)) {
            return;
        }
        ...
        event.setAmount(originalDamage * EtherealBattleAxeItem.PHYSICAL_DAMAGE_PERCENT);


        float holyDamage = originalDamage * EtherealBattleAxeItem.HOLY_DAMAGE_PERCENT;
