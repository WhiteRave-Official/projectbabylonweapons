...
public class GoldenLongswordMagicDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof GoldenLongswordItem)) {
            return;
        }
        ...
        float bonusMagicDamage = event.getAmount() * GoldenLongswordItem.BONUS_MAGIC_DAMAGE_PERCENT;
