...
public class EtherealLongswordHolyDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof EtherealLongswordItem)) {
            return;
        }
        ...
        event.setAmount(originalDamage * EtherealLongswordItem.PHYSICAL_DAMAGE_PERCENT);


        float holyDamage = originalDamage * EtherealLongswordItem.HOLY_DAMAGE_PERCENT;
