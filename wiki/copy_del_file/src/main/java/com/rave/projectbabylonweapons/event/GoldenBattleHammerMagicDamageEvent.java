...
public class GoldenBattleHammerMagicDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof GoldenBattleHammerItem)) {
            return;
        }
        ...
        float bonusMagicDamage = event.getAmount() * GoldenBattleHammerItem.BONUS_MAGIC_DAMAGE_PERCENT;
