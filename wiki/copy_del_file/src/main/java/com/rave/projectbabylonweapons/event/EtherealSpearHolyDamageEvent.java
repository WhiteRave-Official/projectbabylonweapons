...
public class EtherealSpearHolyDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof EtherealSpearItem)) {
            return;
        }
        ...
        event.setAmount(originalDamage * EtherealSpearItem.PHYSICAL_DAMAGE_PERCENT);


        float holyDamage = originalDamage * EtherealSpearItem.HOLY_DAMAGE_PERCENT;
