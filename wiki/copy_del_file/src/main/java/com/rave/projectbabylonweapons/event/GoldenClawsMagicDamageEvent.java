...
public class GoldenClawsMagicDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof GoldenClawsItem)) {
            return;
        }
        ...
        float bonusMagicDamage = event.getAmount() * GoldenClawsItem.BONUS_MAGIC_DAMAGE_PERCENT;
