...
public class EtherealRapierHolyDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof EtherealRapierItem)) {
            return;
        }
        ...
        event.setAmount(originalDamage * EtherealRapierItem.PHYSICAL_DAMAGE_PERCENT);


        float holyDamage = originalDamage * EtherealRapierItem.HOLY_DAMAGE_PERCENT;
