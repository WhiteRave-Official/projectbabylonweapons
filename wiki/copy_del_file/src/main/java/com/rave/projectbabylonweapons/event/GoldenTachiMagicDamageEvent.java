...
public class GoldenTachiMagicDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof GoldenTachiItem)) {
            return;
        }
        ...
        float bonusMagicDamage = event.getAmount() * GoldenTachiItem.BONUS_MAGIC_DAMAGE_PERCENT;
