...
public class GoldenDaggerMagicDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof GoldenDaggerItem)) {
            return;
        }
        ...
        float bonusMagicDamage = event.getAmount() * GoldenDaggerItem.BONUS_MAGIC_DAMAGE_PERCENT;
