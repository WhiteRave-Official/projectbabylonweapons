...
public class GoldenGreatswordMagicDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof GoldenGreatswordItem)) {
            return;
        }
        ...
        float bonusMagicDamage = event.getAmount() * GoldenGreatswordItem.BONUS_MAGIC_DAMAGE_PERCENT;
