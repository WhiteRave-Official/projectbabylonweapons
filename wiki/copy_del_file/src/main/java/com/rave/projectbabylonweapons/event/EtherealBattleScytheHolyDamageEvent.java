...
public class EtherealBattleScytheHolyDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof EtherealBattleScytheItem)) {
            return;
        }
        ...
        event.setAmount(originalDamage * EtherealBattleScytheItem.PHYSICAL_DAMAGE_PERCENT);


        float holyDamage = originalDamage * EtherealBattleScytheItem.HOLY_DAMAGE_PERCENT;
