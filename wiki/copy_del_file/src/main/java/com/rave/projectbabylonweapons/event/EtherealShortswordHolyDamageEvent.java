...
public class EtherealShortswordHolyDamageEvent {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (!(weapon.getItem() instanceof EtherealShortswordItem)) {
            return;
        }
        ...
        event.setAmount(originalDamage * EtherealShortswordItem.PHYSICAL_DAMAGE_PERCENT);


        float holyDamage = originalDamage * EtherealShortswordItem.HOLY_DAMAGE_PERCENT;
